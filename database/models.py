...
created_time = Annotated[datetime, mapped_column(
    DateTime(timezone=True), server_default=func.now())]
updated_time = Annotated[datetime, mapped_column(
...
class Link(Base):
    ...
    original_link: Mapped[HttpUrl] = mapped_column(
        HttpUrlType, nullable=False, unique=False)
...
class Click(Base):
    ...
    id: Mapped[int_pk]
    link_id: Mapped[int] = mapped_column(ForeignKey(
        "links.id", ondelete="CASCADE"), nullable=False)
